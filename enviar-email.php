...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->Host       = 'smtp.live.com';  // SEU HOST (HOSPEDAGEM)
    $mail->SMTPAuth   = true;                        // Manter em true
    $mail->Username   = 'email@hotmail.com';   //SEU USUÁRIO DE EMAIL
    $mail->Password   = '123456';                   //SUA SENHA DO EMAIL SMTP password
    $mail->SMTPSecure = 'ssl';    //TLS OU SSL-VERIFICAR COM A HOSPEDAGEM
    $mail->Port       = 955;     //TCP PORT, VERIFICAR COM A HOSPEDAGEM
    $mail->CharSet = 'UTF-8';    //DEFINE O CHARSET UTILIZADO
    
    //Recipients
    $mail->setFrom('thiagolemos1995@hotmail.com', 'Site');  //DEVE SER O MESMO EMAIL DO USERNAME
    $mail->addAddress('thiagolemos1995@hotmail.com');     // QUAL EMAIL RECEBERÁ A MENSAGEM!
